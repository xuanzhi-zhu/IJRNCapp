...
K_beta_x=1;%%para(25)
K_beta_y=1;%%para(26)
% para=[r_index;m;gra;kp;kv;gamma;kw;M_beta;K_beta;e1;e2;e3;epsilon;sigma;eta;delta];
...
t_w_q_remain=t;
j_w_q_remain=j;
save data_t_j_w_q_remain t_w_q_remain j_w_q_remain

% t_w_q_switched=t;
% j_w_q_switched=j;
% save data_t_j_w_q_switched t_w_q_switched j_w_q_switched